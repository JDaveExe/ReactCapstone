...
const Homepage = () => {
  ...
  const handleNavigation = (path, isServices = false) => (e) => {
    // Prevent default link behavior
    e.preventDefault();
    
    // If it's the services link, do nothing as specified
    if (isServices) return;
    
    // For all other links, navigate to the specified path
    ...
    <div className="homepage">
      ...
      <nav className="navbar">
        <div className="navbar-brand">
          <a href="/" onClick={handleNavigation("/")}>Maybunga Health Center</a>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between">
            ...
            <div className="mb-6 md:mb-0">
              ...
              <ul className="space-y-2">
                <li><a href="/about-us" onClick={handleNavigation("/about-us")} className="hover:underline">About Us</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/contact" onClick={handleNavigation("/contact")} className="hover:underline">Contact Us</a></li>
