      ...
      <div className="login-form">
        ...
        {!isQrLogin ? (
          ...
          <div className="auth-form-container w-100">
            ...
            <div className="d-flex justify-content-between align-items-center mb-4 w-100">
              ...
              <a href="#" className="text-primary forgot-password-link">Forgot password?</a>
            </div>
        ...
        <div className="text-center mt-3 w-100">
          <button
            ...
            style={{maxWidth: "400px", margin: "0 auto", padding: "10px", fontWeight: "500"}}
          >
            {isQrLogin ? (
              <>Login with Password</>
            ) : (
              <>
                <span className="me-2">
                  <i className="bi bi-qr-code" style={{fontSize: "18px"}}></i>
                </span>
                Login with QR Code
              </>
            )}
    ...
    return (
      <div className="registration-form">
        ...
        {showQrCode && registrationComplete ? (
          <div className="qr-code-container text-center w-100">
          ...
          <div className="auth-form-container w-100">
            <Form onSubmit={handleSubmit} className="w-100">
              ...
              <Row className="mb-3">
                ...
                <Col md={6}>
                  <Form.Group controlId="phoneNumber">                    <Form.Control
                      type="tel"
